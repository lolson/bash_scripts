...
prepare()
{
        ...
        cd /root/rpmbuild/RPMS/x86_64 && rpm -Uvh fontconfig*
        ...
        rpm -Uvh https://dl.fedoraproject.org/pub/archive/fedora/linux/releases/15/Fedora/x86_64/os/Packages/autoconf-2.68-2.fc15.noarch.rpm
                 https://dl.fedoraproject.org/pub/archive/fedora/linux/releases/15/Fedora/x86_64/os/Packages/m4-1.4.16-1.fc15.x86_64.rpm
